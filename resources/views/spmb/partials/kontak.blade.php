        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid lg:grid-cols-2 gap-12">
                            ...
                            <div>
                                ...
                                <div class="space-y-1">
                                    <div>
                                        ...
                                        <a href="mailto:info@smpharapanbangsa.sch.id" class="text-gray-800 font-semibold hover:text-primary-600 transition">
                                            info@smpharapanbangsa.sch.id
                                        </a>
                                    </div>
                                    <div>
                                        <div class="text-sm text-gray-500">Email SPMB</div>
                                        <a href="mailto:spmb@smpharapanbangsa.sch.id" class="text-gray-800 font-semibold hover:text-primary-600 transition">
                ...
                <div class="space-y-6">
                    ...
                    {{-- Social Media --}}
                    <div class="bg-gradient-to-br from-primary-600 to-accent-600 rounded-3xl p-8 text-white shadow-lg">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <a href="#" target="_blank" class="flex items-center space-x-3 bg-white/10 hover:bg-white/20 rounded-xl p-4 transition">
