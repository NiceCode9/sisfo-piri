...
@section('title', 'Nexus Admin — Salin Penugasan')
@section('breadcrumb', 'Salin Penugasan')

@section('content')
<div class="page-header d-flex flex-wrap align-items-start justify-content-between gap-3">
    <div>
        <h1 class="page-title">Salin Penugasan</h1>
        <p class="page-subtitle mb-0">Duplikasi penugasan + wali kelas ke tahun ajaran lain (yang sudah ada dilewati)</p>
    </div>
...
<div class="card-nexus">
    <div class="card-header-nexus">
        <div><h5 class="card-title">Sumber & Tujuan</h5><p class="card-subtitle">Tahun sumber: {{ $jumlahSumber }} penugasan + {{ $jumlahWaliSumber }} wali</p></div>
    </div>
    <div class="card-body-nexus">
        <form method="POST" action="{{ route('admin.pengampus.salin.proses') }}">
            @csrf
            ...
            <div class="alert alert-info py-2" style="font-size:12.5px;">Baris yang sudah ada di tahun tujuan (kombinasi mapel + kelas / kelas wali yang sama) dilewati dan dilaporkan. Setelah salin, ubah manual yang bertukar guru.</div>
