...
@section('title', 'Nexus Admin — Ubah Menu')
@section('breadcrumb', 'Ubah Menu')

@section('content')
<div class="page-header d-flex flex-wrap align-items-start justify-content-between gap-3">
    <div>
        <h1 class="page-title">Ubah Menu</h1>
...
<div class="card-nexus">
    <div class="card-header-nexus">
        <div>
            ...
            <p class="card-subtitle">Perbarui data menu</p>
        </div>
    </div>
    <div class="card-body-nexus">
        <form method="POST" action="{{ route('admin.menus.update', $menu) }}">
            @csrf
            @method('PUT')
            @include('admin.menus._form', ['menu' => $menu, 'parentMenus' => $parentMenus, 'permissions' => $permissions, 'permissionIds' => $permissionIds])
