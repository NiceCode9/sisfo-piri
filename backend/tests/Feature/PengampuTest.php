...
if (! function_exists('buatRombelDasar')) {
    function buatRombelDasar(): array
    {
...
test('super-admin dapat menambah penugasan via rombel', function () {
    $d = buatRombelDasar();
...
test('duplikat mapel-rombel ditolak', function () {
    $d = buatRombelDasar();
    Pengampu::create([
        'guru_id' => $d['guru']->id,
        'mata_pelajaran_id' => $d['mapel']->id,
...
test('mapel sama boleh beda rombel (histori utuh)', function () {
    $d = buatRombelDasar();
    Pengampu::create([
        'guru_id' => $d['guru']->id,
        'mata_pelajaran_id' => $d['mapel']->id,
    ...
    $rombelLalu = Rombel::create(['kelas_id' => $d['kelas']->id, 'tahun_ajaran_id' => $tahunLalu->id]);

    $response = $this->actingAs(superAdmin())->post(route('admin.pengampus.store'), [
        'guru_id' => $d['guru']->id,
        'mata_pelajaran_id' => $d['mapel']->id,
        'rombel_id' => $rombelLalu->id,
    ]);
