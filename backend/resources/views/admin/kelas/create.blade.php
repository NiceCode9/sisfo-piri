...
@section('title', 'Nexus Admin — Tambah Kelas')
...
<div class="page-header d-flex flex-wrap align-items-start justify-content-between gap-3">
    <div>
        ...
        <p class="page-subtitle mb-0">Buat kelas baru (berlaku lintas tahun)</p>
    </div>
...
<div class="card-nexus">
    <div class="card-header-nexus"><div><h5 class="card-title">Form Kelas</h5><p class="card-subtitle">Contoh: 7A tingkat 7</p></div></div>
