...
@section('title', 'Nexus Admin — Ubah Pembayaran')
@section('breadcrumb', 'Ubah Pembayaran')

@section('content')
<div class="page-header d-flex flex-wrap align-items-start justify-content-between gap-3">
    <div>
        <h1 class="page-title">Ubah Pembayaran</h1>
...
<div class="card-nexus">
    ...
    <div class="card-body-nexus">
        <form method="POST" action="{{ route('admin.pembayarans.update', $pembayaran) }}" enctype="multipart/form-data">
            @csrf @method('PUT')
            @include('admin.pembayarans._form', ['pembayaran'=>$pembayaran,'calons'=>$calons,'biayas'=>$biayas])
